    ...
    >
      ...
      {routes.length > 0 ? (
        <div className="mt-6 grid gap-3.5">
          {routes.map((route) => (
            <div key={route.route} className="flex flex-col gap-1 rounded-2xl border border-[#d8c5ad] bg-[#f7e8d3] px-4 py-4 text-sm sm:flex-row sm:items-center sm:justify-between">
