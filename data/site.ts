...
export const heroContent = {
  eyebrow: "Этап 3",
  title: "Контент вынесен в data-модули и готов к дальнейшей сборке секций.",
  description: [
    "Все ключевые тексты, контакты, маршруты, FAQ и отзывы теперь лежат отдельно от JSX.",
    "Следующий этап можно начинать с компонентной сборки, не трогая сами данные.",
  ],
  highlights: [
